  ...
  return (
    <div className="min-h-screen flex flex-col">
      <div className="px-6 py-3 flex items-center justify-between border-b">
        <h1 className="text-xl font-bold">Video Magic AI</h1>
        <div className="flex items-center gap-3">
          ...
          <a
            href="https://github.com/C0W3T4/video-magic-ai"
            target="_blank"
            rel="noreferrer"
          >
      ...
      <main className="flex-1 p-6 flex gap-6">
        <div className="flex flex-col flex-1 gap-4">
          ...
          <p className="text-sm text-muted-foreground">
            ...
            prompt to add the content of the transcription of the selected
            video.
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <span className="block text-sm text-muted-foreground italic leading-relaxed">
                Higher values tend to make the result more creative and may have
                possible errors.
              </span>
            </div>
            <Separator />
